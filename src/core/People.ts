...
export class People {
  ...
  public static async getPersonByUID(UID: number): Promise<Person | undefined> {
    try {
      ...
      /* ToDo {
          Точно ошибка сети?
          Предлагаю написать в общем: "Ошибка запроса информации о пользователе:".
          Таким образом обобщим для всех ошибок, но конкретизируем место ошибки.
          Если есть предложения по альтернативным формулировкам или
          есть желание оставить этот вариант - готов к обсуждению.
       }*/
